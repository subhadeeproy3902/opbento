...
const generateSvg = (stats: UserStats, username: string) => {
  ...
  return `
    ...
    >
      ...
      {/* Title */}
      <text x="20" y="40" fontSize="20" fill="#cdd6f4" font-family="Verdana, sans-serif" font-weight="700">
      ...
      <g transform="translate(20, 60)">
        ...
        <text x="60" y="70" fontSize="24" font-family="Verdana, sans-serif" font-weight="700" fill="#f9e2af">
          {/* Stars */}
          ${stars}
        </text>
        ...
        <g transform="translate(240, 0)">
          ...
          <text x="60" y="70" fontSize="24" font-family="Verdana, sans-serif" font-weight="700" fill="#94e2d5">
            ${commits}
          </text>
        </g>
        ...
        <g transform="translate(0, 120)">
          ...
          <text x="20" y="87" fontSize="24" font-family="Verdana, sans-serif" font-weight="700" fill="#f38ba8">
            ${prs}
          </text>
        </g>
        ...
        <g transform="translate(160, 120)">
          ...
          <text x="20" y="87" fontSize="24" font-family="Verdana, sans-serif" font-weight="700" fill="#fab387">
            ${issues}
          </text>
        </g>
        ...
        <g transform="translate(320, 120)">
          ...
          <text x="20" y="87" fontSize="24" font-family="Verdana, sans-serif" font-weight="700" fill="#a6e3a1">
            ${contributedTo}
          </text>
        </g>
      </g>
