...
const generateSvg = (stats: UserStats, username: string) => {
  ...
  return `
    ...
    >
      ...
      {/* Title */}
      <text x="20" y="40" font-size="24" font-family="Verdana, sans-serif" font-weight="700">
      ...
      <g transform="translate(20, 60)">
        ...
        <text x="60" y="35" font-size="16" font-family="Verdana, sans-serif" font-weight="700" >
          Total Stars Earned
        </text>
        ...
        <g transform="translate(0, 120)">
          ...
          <text x="20" y="60" font-size="16" font-family="Verdana, sans-serif" font-weight="700" >
            Total PRs
          </text>
